    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-album-cover-art.png", new TimeSpan(0, 1, 5, 0, 0), new DateOnly(2024, 7, 5), 5, "A Great Chaos (Deluxe)" },
                    { new Guid("21111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-album-cover-art.png", new TimeSpan(0, 0, 40, 49, 0), new DateOnly(2017, 10, 20), 6, "Super Slimey" },
                    { new Guid("31111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-album-cover-art.png", new TimeSpan(0, 0, 36, 25, 0), new DateOnly(2020, 4, 17), 4, "Pray For Paris" },
                    { new Guid("41111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-album-cover-art.png", new TimeSpan(0, 1, 17, 0, 0), new DateOnly(2023, 3, 31), 6, "CALL ME IF YOU GET LOST: The Estate Sale" },
                    { new Guid("51111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-album-cover-art.png", new TimeSpan(0, 1, 1, 0, 0), new DateOnly(2022, 10, 31), 4, "XTENDED" },
                    { new Guid("61111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-album-cover-art.png", new TimeSpan(0, 0, 54, 32, 0), new DateOnly(2025, 9, 22), 6, "ᐸ/3³" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("01111111-1111-1111-1111-111111111111"), 0, "a8fad0d6-07eb-4351-89f2-01c05e8d0efb", "kenCarson@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "kenCarson@gmail.com", "kenCarson", "AQAAAAIAAYagAAAAEMCQLcAIPG2V534FN4zOvwTsY+yqy0vqMhHzfOXy+biQmpvFrF+VjIWU3JMycLzTKA==", null, false, "01111111-1111-1111-1111-111111111111", false, "kenCarson" },
                    { new Guid("02111111-1111-1111-1111-111111111111"), 0, "2464e55b-6649-43df-a9fc-e11282cba159", "future@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "future@gmail.com", "future", "AQAAAAIAAYagAAAAEDTwD8DDJoZ5M+E2xrkKJluvRNRA0eWKLxkQAiF3SIkx74yjnXOdGGst5K4K7ufXTw==", null, false, "02111111-1111-1111-1111-111111111111", false, "future" },
                    { new Guid("03111111-1111-1111-1111-111111111111"), 0, "60e81486-52aa-4bb4-afa2-678b4c4b7f09", "youngThug@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "youngThug@gmail.com", "youngThug", "AQAAAAIAAYagAAAAEMf53InG1thALVUnjM2MfrqwvbJj8SSk1lREnwMzF1AFaS1OekK1JZyEVDde9dl1KA==", null, false, "03111111-1111-1111-1111-111111111111", false, "youngThug" },
                    { new Guid("04111111-1111-1111-1111-111111111111"), 0, "0b6cef5c-9c7e-4add-9312-87c0edc15553", "westsideGunn@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "westsideGunn@gmail.com", "westsideGunn", "AQAAAAIAAYagAAAAELfuuUGxI66glUG0CdIe9sNu08L63BxAMTok6WBZiAcD3nexKKi0zNHHkT7B7ybmGA==", null, false, "04111111-1111-1111-1111-111111111111", false, "westsideGunn" },
                    { new Guid("05111111-1111-1111-1111-111111111111"), 0, "53d9903c-3381-4422-bf37-527728fa320b", "tylerTheCreator@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "tylerTheCreator@gmail.com", "tylerTheCreator", "AQAAAAIAAYagAAAAEAp37uuMqZbRr95ngfh/SZ+BYvLUS5JWD09sGqb854utN5jGCbiBHsPdSTZ8M4m3CA==", null, false, "05111111-1111-1111-1111-111111111111", false, "tylerTheCreator" },
                    { new Guid("06111111-1111-1111-1111-111111111111"), 0, "14cd42e4-4ae3-4801-abaf-2bc1b894baa5", "destroyLonely@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "destroyLonely@gmail.com", "destroyLonely", "AQAAAAIAAYagAAAAEK4lUILXQ6pZPPFLjRbejhBP6nl2ktUSE68MkBpqZCrLvqDTSo5GtPHcduBlJP9/pQ==", null, false, "06111111-1111-1111-1111-111111111111", false, "destroyLonely" },
                    { new Guid("07111111-1111-1111-1111-111111111111"), 0, "b5d1d35a-f83a-4982-91d1-ca8a8acc3e7c", "joeyBada$$@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "joeyBada$$@gmail.com", "joeyBada$$", "AQAAAAIAAYagAAAAECBwqvcsyuLnj4g01HBW51F0MK/xKvSz2Bibwc4jzhUJT7YVgw0uXoc+cIw0pRsVFQ==", null, false, "07111111-1111-1111-1111-111111111111", false, "joeyBada$$" },
                    { new Guid("08111111-1111-1111-1111-111111111111"), 0, "14b5d263-1022-4e9e-bc96-3180baf21555", "billiEssco@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "billiEssco@gmail.com", "billiEssco", "AQAAAAIAAYagAAAAENXjVDHeG23yUhS8tz3lg4+iVo0kogrSKeg3Q9e+VkntMviQRjaGquqUtqS8Jsa25Q==", null, false, "08111111-1111-1111-1111-111111111111", false, "billiEssco" },
                    { new Guid("09111111-1111-1111-1111-111111111111"), 0, "0c79c560-7bcd-4998-90aa-561f7a8e3710", "lilWayne@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "lilWayne@gmail.com", "lilWayne", "AQAAAAIAAYagAAAAEArT88fhPxiEk0fHsCk5MBuPqZMGiwZRpzS396WiUfJcjfWDZCFl+8xHGRKQR7CoMQ==", null, false, "09111111-1111-1111-1111-111111111111", false, "lilWayne" },
                    { new Guid("10111111-1111-1111-1111-111111111111"), 0, "db07f996-6b16-4f03-ba7f-27a885649ac0", "homixideGang@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "homixideGang@gmail.com", "homixideGang", "AQAAAAIAAYagAAAAEGpbK3DNt9DCVM0zdOsF8f/wpqu5Fmzu6UCt9vBXDvmHOQL4XNUSFejnU4K3+s4tiQ==", null, false, "10111111-1111-1111-1111-111111111111", false, "homixideGang" },
                    { new Guid("11111111-1111-1111-1111-111111111111"), 0, "b914d59e-86e0-483e-8ed8-e7cbfc609437", "stdimov2007@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "stdimov2007@gmail.com", "stasko456", "AQAAAAIAAYagAAAAELjtGitDhoryjGrbCACTaW6f4Q6qjyraoTnAo2NY/nzZjT5x+Xv8CAvg+9ri+Iv4MQ==", null, false, "11111111-1111-1111-1111-111111111111", false, "stasko456" },
                    { new Guid("12111111-1111-1111-1111-111111111111"), 0, "1abb4043-bde4-42e1-982a-08d027c1d9fc", "simon2403e8@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "simon2403e8@gmail.com", "simon333", "AQAAAAIAAYagAAAAEK1yE0XxN/TfWXDRLW2giXcDlbcpXhNpKiJkOtodf7Uh9tT1vRppa0X34TIz/cxFnQ==", null, false, "12111111-1111-1111-1111-111111111111", false, "simon333" },
                    { new Guid("13111111-1111-1111-1111-111111111111"), 0, "73524820-b4d5-4671-8cc7-e367b9cb2199", "nikolaPeew@gmail.com", false, "/wwwroot/images/defaults/default-user-pfp.png", false, null, "nikolaPeew@gmail.com", "n_peew07", "AQAAAAIAAYagAAAAEJUKBXy5HRyK11s4mUDbJLi8rQ0AomnyRYhnVPvaCv3vUv6gj59XWi0CjY1dKv1TSQ==", null, false, "13111111-1111-1111-1111-111111111111", false, "n_peew07" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), new DateOnly(2024, 12, 4), "/wwwroot/images/defaults/default_album_cover.png", true, new TimeSpan(0, 0, 16, 59, 0), 6, "Hip-Hop & Trap Filmar", new Guid("01111111-1111-1111-1111-111111111111") },
                    { new Guid("21111111-1111-1111-1111-111111111111"), new DateOnly(2024, 12, 10), "/wwwroot/images/defaults/default_album_cover.png", true, new TimeSpan(0, 0, 19, 9, 0), 7, "00PIUMxx Filmar", new Guid("02111111-1111-1111-1111-111111111111") },
                    { new Guid("31111111-1111-1111-1111-111111111111"), new DateOnly(2022, 6, 27), "/wwwroot/images/defaults/default_album_cover.png", false, new TimeSpan(0, 0, 22, 29, 0), 8, "Mnooo Cherno", new Guid("03111111-1111-1111-1111-111111111111") }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("01111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 8, 0), 10044245, new DateOnly(2024, 7, 5), "Green Room" },
                    { new Guid("02111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 20, 0), 643545, new DateOnly(2024, 7, 5), "Lose It" },
                    { new Guid("03111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 54, 0), 234566, new DateOnly(2024, 7, 5), "Me N My Kup" },
                    { new Guid("04111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("31111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 7, 0), 8384754, new DateOnly(2024, 7, 5), "Paranoid" },
                    { new Guid("05111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), new Guid("31111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 4, 0), 3647835, new DateOnly(2024, 7, 5), "ss" },
                    { new Guid("06111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 24, 0), 125467, new DateOnly(2017, 10, 20), "No Cap" },
                    { new Guid("07111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 24, 0), 125467, new DateOnly(2017, 10, 20), "All da Smoke" },
                    { new Guid("08111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 26, 0), 125467, new DateOnly(2017, 10, 20), "200" },
                    { new Guid("09111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 46, 0), 125467, new DateOnly(2017, 10, 20), "Cruise Ship" },
                    { new Guid("10111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 46, 0), 235678, new DateOnly(2017, 10, 20), "Feed Me Dope" },
                    { new Guid("11111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), new Guid("21111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 40, 0), 98765, new DateOnly(2017, 10, 20), "Killed Before" },
                    { new Guid("12111111-1111-1111-1111-111111111111"), new Guid("31111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 1, 35, 0), 123456, new DateOnly(2020, 4, 17), "No Vacancy" },
                    { new Guid("13111111-1111-1111-1111-111111111111"), new Guid("31111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 5, 49, 0), 654321, new DateOnly(2020, 4, 17), "327" },
                    { new Guid("14111111-1111-1111-1111-111111111111"), new Guid("31111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 1, 49, 0), 234567, new DateOnly(2020, 4, 17), "Euro Step" },
                    { new Guid("15111111-1111-1111-1111-111111111111"), new Guid("31111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 4, 0), 345678, new DateOnly(2020, 4, 17), "Versace" },
                    { new Guid("16111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 35, 0), 456789, new DateOnly(2023, 3, 31), "HOT WIND BLOWS" },
                    { new Guid("17111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 8, 35, 0), 567890, new DateOnly(2023, 3, 31), "WILSHIRE" },
                    { new Guid("18111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 57, 0), 678901, new DateOnly(2023, 3, 31), "SAFARI" },
                    { new Guid("19111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 36, 0), 789012, new DateOnly(2023, 3, 31), "WHAT A DAY" },
                    { new Guid("20111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 41, 0), 890123, new DateOnly(2023, 3, 31), "DOGTOOTH" },
                    { new Guid("21111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 50, 0), 901234, new DateOnly(2023, 3, 31), "HEAVEN TO ME" },
                    { new Guid("22111111-1111-1111-1111-111111111111"), null, new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 20, 0), 12345, new DateOnly(2019, 7, 30), "Bane" },
                    { new Guid("23111111-1111-1111-1111-111111111111"), null, new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 14, 0), 23456, new DateOnly(2023, 3, 3), "if looks could kill" },
                    { new Guid("24111111-1111-1111-1111-111111111111"), null, new Guid("31111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 4, 46, 0), 34567, new DateOnly(2023, 9, 1), "Kat Food" },
                    { new Guid("25111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), new Guid("31111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 48, 0), 45678, new DateOnly(2022, 10, 31), "MDMA" },
                    { new Guid("26111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 18, 0), 78901, new DateOnly(2022, 10, 31), "Freestyle 2" },
                    { new Guid("27111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), new Guid("41111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 2, 45, 0), 56789, new DateOnly(2022, 10, 31), "Delinquent" },
                    { new Guid("28111111-1111-1111-1111-111111111111"), new Guid("51111111-1111-1111-1111-111111111111"), new Guid("11111111-1111-1111-1111-111111111111"), "/wwwroot/images/defaults/default-song-cover-art.png", new TimeSpan(0, 0, 3, 21, 0), 67890, new DateOnly(2022, 10, 31), "Fashion Habits" }
                });
